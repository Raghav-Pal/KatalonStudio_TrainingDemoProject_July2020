...
Mobile.startApplication('bs://9400388f62957480a21586d42763bb9f0d9c4160', true)

Mobile.tap(findTestObject('Mobile/HorizontalSwipe/android.widget.CheckBox0 - Dont show this message again'), 0)

Mobile.tap(findTestObject('Mobile/HorizontalSwipe/android.widget.Button2 - Ok'), 0)

Mobile.waitForElementPresent(findTestObject('Mobile/HorizontalSwipe/android.widget.TextView0 - SwipeListView Demo'), 0)
